(() => {
  const messages = {
    zh: {
      ...
      'supportDialog.choicesLabel': '支持金额',
      'supportDialog.planChoice': '固定方案',
      'supportDialog.customChoice': '自选金额',
      'supportDialog.planHint': '选择固定方案，或切换到官方页面填写自选金额。',
      'supportDialog.customHint': '已切换到爱发电官方主页，请在官方页面填写并确认自选金额。',
    ...
    en: {
      ...
      'supportDialog.choicesLabel': 'Support amount',
      'supportDialog.planChoice': 'Fixed plans',
      'supportDialog.customChoice': 'Custom amount',
      'supportDialog.planHint': 'Choose a fixed plan, or switch to the official page to enter a custom amount.',
      'supportDialog.customHint': 'The official Afdian creator page is open. Enter and confirm your custom amount there.',
