(() => {
  const messages = {
    zh: {
      ...
      'support.dialogKicker': 'SUPPORT MOUMUSIC',
      'support.dialogTitle': '把喜欢变成下一次更新',
      'support.dialogIntro': '感谢你的支持。付款由爱发电官方完成，我们不会在本站收集银行卡、微信或支付宝信息。',
      'support.paymentTitle': '爱发电官方支付',
      'support.paymentBody': '支持微信、支付宝及官方方案',
      'support.paymentButton': '打开付款页',
      'support.dialogNote': '点击后会进入爱发电官方安全页面选择赞助方案。',
      'time.none': '暂无记录',
    ...
    en: {
      ...
      'support.dialogKicker': 'SUPPORT MOUMUSIC',
      'support.dialogTitle': 'Turn appreciation into the next update',
      'support.dialogIntro': 'Thank you for your support. Payment is completed by Afdian; this site never collects card, WeChat Pay, or Alipay details.',
      'support.paymentTitle': 'Official Afdian payment',
      'support.paymentBody': 'WeChat Pay, Alipay, and official support plans',
      'support.paymentButton': 'Open payment page',
      'support.dialogNote': 'You will be taken to the official Afdian page to choose a support plan.',
      'time.none': 'No record',
