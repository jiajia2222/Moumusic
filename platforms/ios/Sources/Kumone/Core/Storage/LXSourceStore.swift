...
final class LXSourceStore: ObservableObject {
    ...
    func importScript(_ data: Data, suggestedName: String) throws {
    ...
    private func decodeExport(_ raw: String) -> Source? {
    ...
    private func sourceFromHeader(_ raw: String, suggestedName: String) -> Source {
