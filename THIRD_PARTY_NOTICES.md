...
- Location: `platforms/ios`（仅保留参考源码；当前发布版不使用其 UI）
...
Moumusic 的新增修改包括共享双端发布、Moumusic 品牌界面、平台/播放音源分层、iOS 原生桥接和发布配置；上游代码的版权和许可证继续适用。用户导入的音源脚本由用户自行提供，仓库不预置第三方音源脚本或服务地址。
